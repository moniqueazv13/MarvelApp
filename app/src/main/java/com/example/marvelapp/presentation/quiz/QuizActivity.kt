...
import com.example.marvelapp.presentation.quiz.FragmentConfirmRight
import com.example.marvelapp.presentation.quiz.FragmentHint
...
class QuizActivity : AppCompatActivity() {
    ...
    private fun onShowFragment() {
       FragmentHint()
           .show(supportFragmentManager, "FragmentHint")
    }
